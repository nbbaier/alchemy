...
import type { DispatchNamespace as _DispatchNamespace } from "./dispatch-namespace.js";
...
export type Bound<T extends Binding> = T extends _DispatchNamespace
  ? Service
  : T extends _DurableObjectNamespace
