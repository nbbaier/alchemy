...
/**
 * Import generated Cloudflare Workers types from workerd directory
 * These are programmatically generated to stay in sync with Worker runtime
 */
import type {
  Fetcher,
  Service,
  ...
  Rpc,
} from "./workerd/index.js";

// Re-export types that are used directly in other modules
export type { Fetcher, Service, SocketAddress, SocketOptions };
