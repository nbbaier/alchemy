// Generated Cloudflare Worker types using wrangler CLI
...
export type Service<T extends Rpc.WorkerEntrypointBranded | undefined = undefined> =
  Fetcher<T>;
export type Fetcher<
...
// Additional binding types needed by bound.ts
export interface Fetcher {
  fetch(input: RequestInfo, init?: RequestInit): Promise<Response>;
}

export interface Service<RPC = unknown> {
  fetch(input: RequestInfo, init?: RequestInit): Promise<Response>;
}
